    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public ResponseDto? Get(string? userId = "")
        {
            try
            {
                ...
                {
                    objList = _db.OrderHeaders.Include(x => x.OrderDetails).Where(x => x.UserId == userId).OrderByDescending(x => x.OrderHeaderId);
                }
        ...
        public async Task<ResponseDto> CreateStripeSession([FromBody] StripeRequestDto stripeRequestDto)
        {
            try
            {
                ...
                OrderHeader orderHeader = await _db.OrderHeaders.FirstAsync(x => x.OrderHeaderId == stripeRequestDto.OrderHeader.OrderHeaderId);
